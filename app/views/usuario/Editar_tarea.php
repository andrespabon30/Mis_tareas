            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" rows="4"><?php echo htmlspecialchars($tarea['descripcion']); ?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_vencimiento" value="<?php echo $tarea['fecha_vencimiento']; ?>">
                    </div>
